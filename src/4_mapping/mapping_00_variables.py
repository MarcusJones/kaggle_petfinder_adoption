...
out_file_name = "{:03d}_{}.json".format(run_definition['population_number'],run_definition['id'])
out_path = Path(PATH_EXPERIMENT_ROOT).expanduser() / str(run_definition['generation']) / out_file_name
